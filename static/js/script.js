...
function yearInDays()
{
    let calculateYear = prompt("Enter the year to calculate the number of days");
    let yearInDayss = (2020 - calculateYear)*365;
    let h1 = document.createElement("h1");
    let textAnswer = document.createTextNode(" The number of days calculated is " + yearInDayss);
    h1.setAttribute("id", "yearInDays");
...
function reset()
{
    document.getElementById("yearInDays").remove();
}
...
function generateCat()
{
    ...
    image.src="https://thecatapi.com/api/images/get?format=src&type=gif&size=small; height=150, width=150";
